...
/**
 * Returns 2-4 high quality related food photos for any user query or dish topic
 */
export function getRelatedPhotos(querySubject = '') {
  ...
  // Default to vegetable/healthy food photos for ingredient lists like "tomato, cabbage, onion..."
